...
if not os.path.exists(gresource_file):
    print(
        f"CRITICAL: Resource file '{gresource_file}' not found. "
...
try:
    ...
    print(f"Failed to load or register resource '{gresource_file}': {e}. This test cannot proceed meaningfully.")
    sys.exit(1)
...
def main():
    ...
    try:
        ...
        print(
            "main(): The call to read_hosts_file_content_privileged within populate_store also completed without crashing."
        )
